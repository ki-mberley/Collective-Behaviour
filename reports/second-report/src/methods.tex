% Compared to the first report: Less details on how to execute the model (these details can be found in the README on GH) and more focus on the actual ABM algorithm, e.g., how do the sheep move
