...
def load_params_auto(file_pointer = '../simulation/params.txt'):
...
def make_movie_clone():
  ...
  #run ffmpeg
  os.system("ffmpeg -loglevel panic -y -r 15 -f image2 -s 1920x1080 -start_number 1 -i ./test_plots/test_plot%04d.png -vframes 1000 -vcodec libx264 -crf 10  -pix_fmt yuv420p plots/output_movie_clone.mp4")
  ...
  #open the created movie
  os.system("open plots/output_movie_clone.mp4")
